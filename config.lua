-- Made by Ziv#8608 for rar5m, ExtraWorld and WhitePlay GTA Whitelist.
-- Guys, DONT sell this config please, its released for free, be a good peoples.
...
QB.Doors = {
	...
	-----
	{
		...
		objYaw = 90.0,
		objCoords  = vector3(419.91, -1017.62, 29.19),
...
------------------------------------------------------
	...
	-- Premium Deluxe Motorsports
	{
		...
		authorizedJobs = { 'cardealer', 'police', 'pdmowner', 'pdmceo', 'pdmmanager', 'pdmemployee', 'pdmlegal'},
		locking = false,
		locked = false,
		pickable = false,
		distance = 2.0,
...
-- Made by Ziv#8608 for rare5m and WhitePlay GTA Whitelist.
-- Made by Ziv#8608 for rare5m and WhitePlay GTA Whitelist.
-- Made by Ziv#8608 for rare5m and WhitePlay GTA Whitelist.
-- Made by Ziv#8608 for rare5m and WhitePlay GTA Whitelist.
-- Made by Ziv#8608 for rare5m and WhitePlay GTA Whitelist.
